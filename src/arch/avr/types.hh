...
namespace gem5
{
    ...
    namespace AVRISAInst
    {
        ...
        public:
            AVRFault(const char *name, uint8_t code)
        ...
        public:
            UnknownInstFault()
                : AVRFault("Unknown instruction", 0)
            {
            }
        ...
        {
        public:
            UnalignedMemAccessFault()
                : AVRFault("Unaligned memory access", 1)
            {
            }
        ...
        public:
            IllegalInstFault()
                : AVRFault("Illegal instruction", 2)
            {
            }
        ...
        public:
            PrivilegeViolationFault()
                : AVRFault("Privilege violation", 3)
            {
            }
        ...
        condCodeToString(ConditionCode cond)
        {
            switch (cond)
            {
            case CondEQ:
